<template>
    <div id="vehicleFuelConsumptionRegistration" v-loading="loading">
        <el-form :inline="true" :model="form" class="ordinary-form" size="small" ref="form">
            ...
            <el-form-item label="月份选择" prop="month">
              <el-date-picker clearable v-model="form.month" style="width: 160px;" type="month" value-format="yyyy-MM" placeholder="月份选择"></el-date-picker>
            </el-form-item>
            <el-form-item>
        ...
        <div :style="{height: height}" class="ordinary-tableBox">
            <el-table :data="tableData" ref="table" stripe size="small" :summary-method="getSummaries" show-summary height="100%">
                ...
                <el-table-column prop="month" label="月份" min-width="90" align="center"></el-table-column>
                ...
                <el-table-column prop="fuelConsumption" label="实用燃油数(升)" align="center"></el-table-column>
                <el-table-column prop="fuelPrice" label="油价格(元)" align="center"></el-table-column>
                <el-table-column prop="gasConsumption" label="实用气(升)" align="center"></el-table-column>
                <el-table-column prop="gasPrice" label="气价格(元)" align="center"></el-table-column>
                <el-table-column prop="fuelPointName" label="加油点" align="center"></el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="dialogVisible" width="700px">
          <el-form :rules="rules" class="editForm" :model="editForm" ref="editForm" style="width: 90%;margin: 0 auto;" size="mini" label-width="120px" v-loading="loading2">
            ...
            <el-form-item label="加油点" prop="fuelPointId">
                <el-select v-model="editForm.fuelPointId" filterable style="width: 100%;">
                    <el-option :label="it.name" :value="it.id" v-for="it in FuelPointOption" :key="it.id"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="实用燃油数(升)" prop="fuelConsumption">
                <el-input v-model="editForm.fuelConsumption"></el-input>
            </el-form-item>
            <el-form-item label="油价格(元)" prop="fuelPrice">
                <el-input v-model="editForm.fuelPrice"></el-input>
            </el-form-item>
            <el-form-item label="实用气(升)" prop="gasConsumption">
                <el-input v-model="editForm.gasConsumption"></el-input>
            </el-form-item>
            <el-form-item label="气价格(元)" prop="gasPrice">
                <el-input v-model="editForm.gasPrice"></el-input>
            </el-form-item>
            <el-form-item label="月份" prop="month">
              <el-date-picker style="width: 100%;" clearable v-model="editForm.month" type="month" value-format="yyyy-MM" placeholder="日期"></el-date-picker>
            </el-form-item>
...
export default {
  data () {
    ...
    return {
      ...
      url: {
        ...
        getData: '/webwms/api/monthEnergy/listMonthEnergyFromLine',
        getLineOption: '/webwms/api/line/getLineOption',
        saveData: '/webwms/api/monthEnergy/saveOrUpdateMonthEnergy',
        delData: '/webwms/api/monthEnergy/deleteMonthEnergy',
        getFuelPoint: '/webwms/fuelPoint/listAllFuelPoint'
      },
      vehicleOption: [],
      lineOption: [],
      FuelPointOption: [],
      form: {
        lineId: '',
        month: this.$public.format(date, 'yyyy-MM')
      },
      editForm: {
        id: 0,
        lineId: '',
      ...
      rules: {
        ...
        fuelConsumption: [
          { required: true, message: '请输入实用燃油数(升)', trigger: 'blur' }
        ],
        fuelPrice: [
          { required: true, message: '请输入油价格(元)', trigger: 'blur' }
        ],
        gasConsumption: [
          { required: true, message: '请输入实用气(升)', trigger: 'blur' }
        ],
        gasPrice: [
          { required: true, message: '请输入气价格(元)', trigger: 'blur' }
        ],
        month: [
  ...
  methods: {
    ...
    getFuelPoint () {
      this.$http.post(this.url.getFuelPoint).then(
        response => {
          var res = response.body
          if (res.success) {
            this.fuelPointOption = res.data
          } else {
...
<style lang="scss">
#vehicleFuelConsumptionRegistration {
    .editForm {
        overflow: hidden;
        .el-form-item {
            width: 50%;
